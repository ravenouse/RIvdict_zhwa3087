...
class RevdictModel(nn.Module):
    ...
    def __init__(
        ...
        self.e_proj1 = nn.Linear(2*hidden_dim,d_model)
        self.e_proj2 = nn.Linear(2*hidden_dim,d_model)
        self.e_proj3 = nn.Linear(2*hidden_dim,d_model)
        self.hidden = None
    ...
    def forward(self, gloss_tensor):
        ...
        return self.e_proj1(F.relu(summed_embs)), self.e_proj2(F.relu(summed_embs)), self.e_proj3(F.relu(summed_embs))
