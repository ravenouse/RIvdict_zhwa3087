...
# --target_arch 'sgns' \
# --summary_logdir ../logs/en_extra/sgns \
# --save_dir ../models/en_extra/sgns \
# --pred_dir ../predictions/en_extra/predictions1.json
...
# --tokenizer ../../tokenizers/en/WordPiece_tokenizer.json \
# --target_arch 'char' \
# --summary_logdir ../logs/en_extra/char \
# --save_dir ../models/en_extra/char \
# --pred_dir ../predictions/en_extra/predictions2.json
...
# --tokenizer ../../tokenizers/en/WordPiece_tokenizer.json \
# --target_arch 'electra' \
# --summary_logdir ../logs/en_extra/electra \
# --save_dir ../models/en_extra/electra \
# --pred_dir ../predictions/en_extra/predictions3.json
